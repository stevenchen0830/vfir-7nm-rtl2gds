...
# Split uncertainty: 150 ps OCV/jitter margin belongs to setup; same-edge
# hold sees almost no jitter, so hold keeps a 30 ps guard band.  The blanket
# single-value form (see constraint_reported.sdc) taxes EVERY hold check
# with the full setup margin - the 8th SDC artifact class of this project.
