...
int8_dw3x1 #(.WIDTH(3),.HEIGHT(3),.CHANNELS(2),.QSHIFT(31),.RELU(0)) dut
(clk,rst_n,iv,ir,din,wreg,breg,ov,ready,dout);
initial begin
stim[0]=16'h180; gold[0]=16'hff01;
stim[1]=16'hd3a7; gold[1]=16'hff01;
stim[2]=16'h303b; gold[2]=16'hff01;
stim[3]=16'h8702; gold[3]=16'hff01;
stim[4]=16'hd9ae; gold[4]=16'hff01;
stim[5]=16'hc2df; gold[5]=16'hff01;
stim[6]=16'h3a4b; gold[6]=16'hff01;
stim[7]=16'h79af; gold[7]=16'hff01;
stim[8]=16'hc800; gold[8]=16'hff01;
stim[9]=16'hd681; gold[9]=16'h1ff;
stim[10]=16'hf63; gold[10]=16'h1ff;
stim[11]=16'h8425; gold[11]=16'h1ff;
stim[12]=16'h419f; gold[12]=16'h1ff;
stim[13]=16'h5c04; gold[13]=16'h1ff;
stim[14]=16'hceef; gold[14]=16'h1ff;
stim[15]=16'ha16b; gold[15]=16'h1ff;
stim[16]=16'hfb2b; gold[16]=16'h1ff;
stim[17]=16'hf073; gold[17]=16'h1ff;
